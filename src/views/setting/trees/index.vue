  ...
  <div class="app-container">
    ...
    <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit stripe highlight-current-row style="width: 100%;">
      ...
      <el-table-column label="操作" align="center" width="230" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
          ...
          <el-button type="success" size="mini" @click="handleEditValue(row)">
            创建子类
          </el-button>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="50%">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="120px" style="margin-left:10px;">
        <el-form-item label="大类名" prop="name">
...
export default {
  ...
  methods: {
    ...
    handleEditValue(row) {
      this.$router.push({ name: 'TreesManageChild', query: { parent: JSON.stringify(row) }})
    }
  }
}
</script>
